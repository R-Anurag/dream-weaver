...
export const sampleBoards: Board[] = [
  {
    ...
    thumbnailUrl: '/images/urbanfarming.png',
    items: [
        { id: generateId(), type: 'image', x: 50, y: 50, width: 400, height: 300, rotation: -2, content: '/images/urbanfarming.png', style: { backgroundColor: '', color: '', fontFamily: '', fontSize: 16, shape: 'rectangle', borderColor: '', borderWidth: 0, textAlign: 'center' } },
  ...
  },
  {
    ...
    thumbnailUrl: '/images/aieducation.png',
    items: [
        { id: generateId(), type: 'image', x: 450, y: 120, width: 400, height: 300, rotation: 3, content: '/images/aieducation.png', style: { backgroundColor: '', color: '', fontFamily: '', fontSize: 16, shape: 'rectangle', borderColor: '', borderWidth: 0, textAlign: 'center' } },
  ...
  },
  {
    ...
    thumbnailUrl: '/images/oceancleanup.png',
     items: [
        { id: generateId(), type: 'image', x: 250, y: 20, width: 500, height: 400, rotation: 0, content: '/images/oceancleanup.png', style: { backgroundColor: '', color: '', fontFamily: '', fontSize: 16, shape: 'rectangle', borderColor: '', borderWidth: 0, textAlign: 'center' } },
  ...
  },
  {
    ...
    thumbnailUrl: '/images/remotework.png',
     items: [
        { id: generateId(), type: 'image', x: 50, y: 50, width: 400, height: 300, rotation: 2, content: '/images/remotework.png', style: { backgroundColor: '', color: '', fontFamily: '', fontSize: 16, shape: 'rectangle', borderColor: '', borderWidth: 0, textAlign: 'center' } },
