...
export const sampleBoards: Board[] = [
  {
    ...
    items: [
        { id: generateId(), type: 'image', x: 50, y: 50, width: 400, height: 300, rotation: -2, content: 'https://placehold.co/400x300', style: { backgroundColor: '', color: '', fontFamily: '', fontSize: 16, shape: 'rectangle', borderColor: '', borderWidth: 0, textAlign: 'center' } },
  ...
  },
  {
    ...
    thumbnailUrl: 'https://placehold.co/800x600',
    items: [
        { id: generateId(), type: 'image', x: 450, y: 120, width: 400, height: 300, rotation: 3, content: 'https://placehold.co/400x300', style: { backgroundColor: '', color: '', fontFamily: '', fontSize: 16, shape: 'rectangle', borderColor: '', borderWidth: 0, textAlign: 'center' } },
  ...
  },
  {
    ...
    thumbnailUrl: 'https://placehold.co/800x600',
     items: [
        { id: generateId(), type: 'image', x: 250, y: 20, width: 500, height: 400, rotation: 0, content: 'https://placehold.co/500x400', style: { backgroundColor: '', color: '', fontFamily: '', fontSize: 16, shape: 'rectangle', borderColor: '', borderWidth: 0, textAlign: 'center' } },
