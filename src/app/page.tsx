        ...
        <section className="relative w-full py-16 md:py-20 lg:py-24 overflow-hidden bg-background">
            <div className="container max-w-7xl relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
                <FloatingItem className="top-10 left-10 w-48 h-32" delay="0.8s">
                    <Image src="/images/landing-hero-1.png" alt="Astronaut in space" fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="object-cover rounded-lg shadow-2xl transform -rotate-6" data-ai-hint="design quote" />
                </FloatingItem>
                <FloatingItem className="top-24 right-1/4 w-40" delay="1s">
                 ...
                 <FloatingItem className="bottom-10 right-10 w-52 h-40" delay="1.2s">
                    <Image src="/images/landing-hero-2.png" alt="Serene landscape" fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="object-cover rounded-lg shadow-2xl transform rotate-2" data-ai-hint="serene landscape" />
                </FloatingItem>
